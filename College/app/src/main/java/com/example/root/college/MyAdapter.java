...
import com.example.root.college.MainActivity;
import com.example.root.college.R;
import com.example.root.college.Student;
        ...
        firebaseDatabaseRef.addValueEventListener(new com.firebase.client.ValueEventListener() {
            ...
            public void onDataChange(com.firebase.client.DataSnapshot dataSnapshot) {
                ...
                for (com.firebase.client.DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if(post.getNamestring().toLowerCase(Locale.getDefault()).contains(finalCharText)) {
                        mLawyer.add(post);
                        notifyDataSetChanged();
                    }
                }
